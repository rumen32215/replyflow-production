...
A heating engineer, fifteen years into building a reputation one word-of-mouth referral at a time, is asked to connect his real WhatsApp number — the number his customers already trust — to a piece of software he met an hour ago.

He doesn't care that it uses AI. He cares whether it will represent his business correctly, because if it doesn't, the damage lands on *his* name, not ReplyFlow's. That is the whole problem this document exists to solve, and it's worth being honest about what does not solve it: better copy, a reassuring tone, a testimonial, a badge. None of those are proof. They're all still just ReplyFlow telling him to trust it.

**Trust has to be demonstrated, not asserted.** Every section below is a different answer to one question, asked at a different moment: *what has the owner actually seen with his own eyes that justifies trusting her with the next thing?*
...
## 2. Meet Your Receptionist

The hinge the whole Trust Experience turns on — the first time the product proves it was actually listening, and the template for how she'll talk about herself for as long as the owner uses ReplyFlow.

### How she introduces herself
Not like a stranger. She's just spent the last ten minutes being taught, and she should open by proving it, not by announcing herself:

> "Hi. I've finished learning about your business. Here's what I've understood: you cover East London. You don't charge call-out fees. Gas smells always come straight to you. **Have I understood you correctly?**"

No "Hi, I'm Sarah" preamble first, no settings-page recap. The introduction *is* the recap, and the recap ends in a question, not a full stop. That one sentence — "have I understood you correctly?" — is what turns this from a presentation into a conversation, and it gives the owner one last, natural opportunity to say "actually... no" before anything is treated as settled. A presentation can't be corrected. A conversation can. That difference is the entire trust mechanism of this moment.

### How she explains what she knows
...
### Making it memorable
The whole moment should read as one continuous message from her, not a form confirmation with her name attached. If the owner only remembers one sentence from onboarding, it should be from this moment.

---

## 3. The Promise

Before any testing. Before WhatsApp. Before anything else happens, she should say one thing plainly, on its own, with nothing else competing for attention around it — not a marketing promise, a behavioural one:
...
This is the direct answer to the exact fear named in §0 — not "trust me," which is a sentence any product can say and none of them earn by saying it, but a specific, checkable commitment about *behaviour*. It works because it's testable: everything in §4 exists specifically to let the owner watch this promise hold up in practice, immediately afterward.

---

## 4. Test Conversations

If Meet Your Receptionist is the introduction, this is the working interview. The owner should leave it able to finish the sentence "I trust her with my customers because I watched her..." — with a real, specific ending, not a vague good feeling.

### How the owner enters it
...
### How she explains why she answered a certain way
A visible, plain-language "why I said that" — the human-readable form of exactly what `facts_used` already carries in the real reply pipeline: "I said we don't charge a call-out fee because that's what you told me." When she escalates instead: "I flagged this because it's a complaint, and you told me complaints always come to you." The difference between trusting a result and trusting the reasoning behind it.

### How the owner teaches her something new, mid-test
...
## 5. The First Live Customer — Shadowing begins

Message one has to feel structurally different from message five hundred, on purpose, because the owner's anxiety is highest exactly then. This whole period has a name on the Confidence Timeline (§7): **Shadowing** — she's working the real job, in full, but every decision still runs through the owner, the same way a new hire's first real days are watched closely without anyone pretending otherwise.

- **Reassurance** — not "New message" but "Your first real customer just messaged — here's what I'd say back."
- **Visibility** — the same reasoning trace surfaced in testing (§4), instantly recognisable as the same thing happening for real.
- **Approval flow** — strictly manual, no exceptions, regardless of any category-level auto-send settings — the first period is a floor, not a default.
- **Confidence** — every correct, unremarkable approval in this window is a small trust deposit, worth letting register as such.
- **Gradual autonomy** — never introduced with fanfare. It should simply become true, quietly, once evidence supports it (§7).

---

## 6. First Success — the first real booking

The moment ReplyFlow books a real job from a real conversation, entirely on its own, deserves to be treated as what it actually is: the first time the product did something that used to cost the owner ten minutes and a phone call, without being asked.

Design this as a specific, plainly-stated fact, not a badge or animation — "Your first booking through ReplyFlow: [customer], [job], [time]. You didn't have to answer that one." Said once, at the exact moment it's true for the first time. It shouldn't be buried in an activity feed — it's earned a moment of its own.
...
**Training → Testing → Shadowing → Observed → Trusted → Autonomous**

- **Training** — taught, not yet seen in action (§2)
- **Testing** — the owner has watched her handle sample conversations (§4)
- **Shadowing** — live with real customers, watching and drafting on genuine conversations, but the owner still makes every decision (§5) — the natural stage between practice and real responsibility
- **Observed** — the settled version of the same manual review, once the anxious edge of Shadowing has worn off — still reviewed every time, but routine now, not nerve-wracking
...
- **Proof Before Ask** — never request a permission, a connection, or an escalation of responsibility without first showing the specific evidence that justifies it, in the same session. The single design law underneath every section above.
- **The Promise** — a single, specific, testable behavioural commitment, made before anything else and then immediately demonstrable (§3).
- **The Why** — a plain-language, always-available explanation of any given reply's reasoning (§4), not just in testing but everywhere she ever answers something.
- **Shadowing, as its own named stage** — the natural, human-feeling middle ground between rehearsal and real responsibility, distinct from the calmer Observed period that follows it.
- **Autonomy is per-category, never global** — already true of the underlying system; now a first-class, named, owner-facing idea.
- **Trust deposits and withdrawals** — every correct, unremarkable approval is a small deposit (§5); every real mistake, honestly owned, is a withdrawal that pauses growth without erasing the balance.
