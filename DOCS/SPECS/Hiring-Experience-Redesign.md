...
**Not an architecture document. No database, no components, no implementation.** This is about how a first-time owner *feels*, screen by screen, from the moment they finish signing up to the moment they're ready to hand over their real WhatsApp number. Living proposal — a challenge to every screen, not a decision yet. Promote the agreed parts into `DOCS/CONSTITUTION/05-Owner-Experience.md` once they're settled; until then this stays here, next to `Trust-Track-Implementation-Plan.md`, which it's a direct companion to.
