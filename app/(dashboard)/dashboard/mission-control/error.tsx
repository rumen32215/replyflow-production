...
/**
 * Same calm, first-person voice as every other error boundary in the
 * app (Front Desk, auth, onboarding) — a failed fetch here should
 * never look like a broken app or show a stack trace.
 */
