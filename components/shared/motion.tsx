 ...
 *  Satisfying, never celebratory — a near-critically-damped spring
 *  (RC6: calmed from a livelier one that read as a small bounce) so
 *  every use of this reads as quiet confidence, not excitement. */
export function GrowingCheck({ className, delay = 0 }: { className?: string; delay?: number }) {
  return (
    <motion.span
